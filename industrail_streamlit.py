...
with tab1:
    ...
    if submit_button and flag == 0:
        ...
        with open(r"C:\\python jyp\\model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r'C:\\python jyp\\scaler.pkl', 'rb') as f:
            scaler_loaded = pickle.load(f)
        with open(r"C:\\python jyp\\t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)
        with open(r"C:\\python jyp\\s.pkl", 'rb') as f:
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"C:\\python jyp\\cmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)
        with open(r'C:\\python jyp\\cscaler.pkl', 'rb') as f:
            cscaler_loaded = pickle.load(f)
        with open(r"C:\\python jyp\\ct.pkl", 'rb') as f:
